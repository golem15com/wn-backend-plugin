...
<html lang="<?= App::getLocale() ?>" class="no-js">
    <head>
        ...
        <title><?= e(Backend\Models\BrandSetting::get('app_name', 'Golem15')) ?> &mdash; <?= e(trans('backend::lang.auth.title')) ?></title>
        ...
        <link rel="stylesheet" href="<?= Url::asset('plugins/golem15/backend/assets/css/auth.css') ?>">
    </head>
    <body class="outer <?= $this->bodyClass ?>">
            ...
            <div class="layout">
                ...
                <div class="layout-row">
                    <div class="layout-cell">
                        <div class="auth-card">
                            <div class="auth-logo">
                                <?php $logoUrl = Backend\Models\BrandSetting::getLogo(); ?>
                                <?php if ($logoUrl): ?>
                                    <img src="<?= e($logoUrl) ?>" alt="<?= e(Backend\Models\BrandSetting::get('app_name', 'Golem15')) ?>">
                                <?php endif; ?>
                            </div>
        ...
        <!-- Flash Messages -->
        <div class="auth-flash-messages" id="layout-flash-messages">
            <?= $this->makeLayoutPartial('flash_messages') ?>
        </div>
